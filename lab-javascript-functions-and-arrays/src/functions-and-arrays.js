...
/* Método Conditional (Ternary) Operator */
let maxOfTwoNumbers = (num1, num2) => num1 > num2 ? num1 : num2;
console.log("Iteration #1: " + maxOfTwoNumbers(5, 10));
...
console.log("Bonus - Iteration #3.1: " + sum(mixedArr));
...
console.log("Iteration #4, level 1: " + averageNumbers(numbersAvg));
...
function averageWordLength(average) {
  ...
  return parseInt(sum/average.length);
}
console.log("Iteration #4, level 2: " + averageWordLength(wordsArr));
...
function avg(mixArr) {
  ...
  return acum/mixArr.length;
}
console.log("Bonus - Iteration #4.1: " + avg(mixedArr));
...
console.log("Iteration #6: " + doesWordExist(wordsFind, "matter"));
